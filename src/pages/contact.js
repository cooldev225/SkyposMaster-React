...
const AboutPage = () => (
  <Layout>
   <CustomTitle heading={'CONTACT US'} />
        ...
        <div className="row">
          <div className="col-lg-6">
            <div className="contact-item">
              ...
              <div>
                <p className="value ">
                  <a className='secondary-color' href={`tel:${phoneNumber}`}>{phoneNumberLabel}</a>
                </p>
              </div>
            </div>
            <div className="contact-item">
              ...
              <div>
                <p className="value ">
                  <a className='secondary-color' href={`mailto:${contactEmail}`}> {contactEmail}</a>
                </p>
              </div>
            </div>
            <div className="contact-item">
              <h6 className="subtitle">
                <i className="ion-android-locate "></i> Visit By Appointment
              </h6>
              <div>
